...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-08-19 09:07:57
-- 服务器版本： 5.6.22
-- PHP Version: 5.6.7
...
CREATE TABLE IF NOT EXISTS `common_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统行为表' AUTO_INCREMENT=7 ;
...
(23, 'WeixinPromotion', '微信接口二维码生成', '生成微信二维码', 1, '{"downloadFolder":".\\/Uploads\\/Qrcode","noAuthorizedMsg":"\\u60a8\\u8fd8\\u672a\\u6210\\u4e3a\\u65cf\\u957f\\uff0c\\u4e0d\\u80fd\\u751f\\u6210\\u4e13\\u5c5e\\u4e8c\\u7ef4\\u7801\\uff01","tmpFolder":".\\/Temp","bgImg":".\\/Temp","mergeFolder":".\\/Uploads\\/QrcodeMerge"}', 'hebidu', '0.1', 1437186509, 0);
...
(1, 'WEBSITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '分销中心', 0),
...
(14, 'goodsType', '最新商品', 0, 1429501808, 1429501808, '0,13,', 13, '', 1, NULL),
(15, 'goodsType', '热门商品', 0, 1429501817, 1429501817, '0,13,', 13, '', 1, NULL),
(16, 'goodsType', '推荐商品', 0, 1429501832, 1429501832, '0,13,', 13, '', 1, NULL),
...
(31, '', '佣金出入类型', 0, 1436597157, 1436597158, '0,', 0, '', 0, ''),
(32, '', '提现', 0, 1436597169, 1436597169, '0,31,', 31, '', 1, ''),
(33, '', '订单完成', 0, 1436597500, 1436597501, '0,31,', 31, '', 1, ''),
(34, '', '审核通过', 0, 1436597519, 1436597519, '0,31,', 31, '', 1, ''),
(35, '0', '物流公司', 0, 1439457688, 1439457688, '0,', 0, '', 0, ''),
(36, '0', '同诚汇速递', 0, 1439457737, 1439457737, '0,35,', 35, '', 1, ''),
(37, '0', '申通快递', 0, 1439457753, 1439457753, '0,35,', 35, '', 1, ''),
(38, '0', '顺丰速运', 0, 1439457766, 1439457766, '0,35,', 35, '', 1, ''),
(39, '0', '圆通速递', 0, 1439457777, 1439457777, '0,35,', 35, '', 1, ''),
(40, '0', '韵达快运', 0, 1439457789, 1439457790, '0,35,', 35, '', 1, ''),
(41, '0', '天天快递', 0, 1439457797, 1439457798, '0,35,', 35, '', 1, ''),
(42, '0', '邮政EMS', 0, 1439457806, 1439457806, '0,35,', 35, '', 1, ''),
(43, '0', '中通速递', 0, 1439457814, 1439457815, '0,35,', 35, '', 1, ''),
(44, '0', '汇通快运', 0, 1439457823, 1439457823, '0,35,', 35, '', 1, ''),
(45, '0', '宅急送', 0, 1439457833, 1439457833, '0,35,', 35, '', 1, ''),
(46, '0', '易迅快递', 0, 1439457843, 1439457844, '0,35,', 35, '', 1, ''),
(47, '0', '广告类型', 0, 1439968006, 1439968006, '0,', 0, '', 0, NULL),
(48, '0', '商城_首页_广告', 0, 1439968110, 1439968110, '0,47,', 47, '', 0, NULL),
(49, '0', '广告视频', 0, 1439968127, 1439968127, '0,47,', 47, '', 0, NULL);
...
CREATE TABLE IF NOT EXISTS `common_member` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最新更新时间',
...
(1, '张三', '331023199810304425', '张三', 0, 0, '9988989', 0, 0, 0, 0, 0, 0, 0, 1);
...
(241, '商城设置', 240, 0, 'Admin/Store/config', 0, '', '', 0, 1),
...
(247, '广告管理', 240, 0, 'Admin/Advert/index', 0, '', '', 0, 1),
(248, '运费模块', 196, 0, '#', 0, '', '', 0, 1),
(249, '运费模板', 248, 0, 'Admin/Freight/index', 0, '', '', 0, 1);
...
INSERT INTO `common_session` (`session_id`, `session_expire`, `session_data`) VALUES
('4broa83v1f69dvidtt2dca9kg4', 1439867179, );
...
--
-- 表的结构 `itboye_distributor_info`
--

CREATE TABLE IF NOT EXISTS `itboye_distributor_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(32) NOT NULL COMMENT '姓名',
  `phone` char(16) NOT NULL COMMENT '手机',
  `address` varchar(128) NOT NULL COMMENT '地址',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `wxaccount_id` int(11) NOT NULL COMMENT '公众号ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分销商申请信息' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `itboye_freight_address`
--

CREATE TABLE IF NOT EXISTS `itboye_freight_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `addressids` varchar(500) NOT NULL DEFAULT '' COMMENT '地区Id集合',
  `addresses` varchar(200) NOT NULL DEFAULT '' COMMENT '地址集合',
  `money` float NOT NULL COMMENT '费用',
...
--
-- 表的结构 `itboye_freight_template`
--

CREATE TABLE IF NOT EXISTS `itboye_freight_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL COMMENT '模板名称',
  `type` int(11) NOT NULL DEFAULT '0' COMMENT '配送类型(0 商家配送,1 用户自提)',
  `company` varchar(100) NOT NULL COMMENT '配送公司',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `itboye_orders` (
  ...
  `comment_status` tinyint(4) NOT NULL COMMENT '0：待评价 1：手动评价 2：自动评价',
  PRIMARY KEY (`id`),
...
--
-- 表的结构 `itboye_order_comment`
--

CREATE TABLE IF NOT EXISTS `itboye_order_comment` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL COMMENT '商品id',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `score` int(11) NOT NULL COMMENT '打分(0-5分)',
  `comment` varchar(512) NOT NULL COMMENT '评论文字',
  `createtime` int(11) NOT NULL COMMENT '创建时间',
  `orders_id` bigint(20) NOT NULL,
  `logistics_service` int(11) NOT NULL COMMENT '物流服务',
  `delivery_speed` int(11) NOT NULL COMMENT '发货速度',
  `service_attitude` int(11) NOT NULL COMMENT '服务态度',
  PRIMARY KEY (`id`),
  KEY `fk_wytch_order_comment_wytch_orders1_idx` (`orders_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单评论' AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `itboye_order_status_history`
--

CREATE TABLE IF NOT EXISTS `itboye_order_status_history` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `reason` varchar(512) NOT NULL COMMENT '状态变更原因',
  `create_time` int(11) NOT NULL COMMENT '变更时间',
  `isauto` tinyint(2) NOT NULL COMMENT '是否是自动变更',
  `orders_id` bigint(20) NOT NULL,
  `cur_status` tinyint(2) NOT NULL,
  `next_status` tinyint(2) NOT NULL,
  `status_type` varchar(10) NOT NULL COMMENT '类型（PAY: 支付状态 ORDER:订单状态 STATUS: 数据状态）',
  `operator` int(11) NOT NULL COMMENT '操作人ID',
  PRIMARY KEY (`id`),
  KEY `fk_wytch_order_status_history_wytch_orders1_idx` (`orders_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单状态变更记录' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `itboye_product` (
  ...
  `profit` decimal(16,2) NOT NULL COMMENT '商品利润',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `itboye_store` (
  ...
  `free_shipping` decimal(16,2) NOT NULL DEFAULT '1000.00' COMMENT '满多少元可免邮',
...
(1, 'zhansan', '123456', '', '13@qq.com', 0, 0, 0, 0, 0, 1, 0);
